...
app.post('/api/bookings', (req, res) => {
  const { room_id, guest_name, guest_email, guest_phone, check_in, check_out, guests, total_price } = req.body;
  ...
  res.json({ success: true, booking_id, message: 'Booking created successfully' });
});
...
app.get('/api/bookings', (req, res) => {
  ...
  res.json(bookingsWithRooms.sort((a, b) => new Date(b.created_at) - new Date(a.created_at)));
});
